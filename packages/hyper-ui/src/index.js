...
export const TopicItem = require('./components/help/topic-item')
export const FrequentlyTradedAssets = require('./components/frequently-traded-assets')
...
export const WalletBase = require('./components/wallet/base')
